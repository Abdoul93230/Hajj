...
// Détail d'une offre CURATÉE (fichier statique offers-data.ts).
// Utilisé en fallback quand le slug ne correspond à aucune offre en DB.
export default function StaticOfferDetail({ slug }: { slug: string }) {
